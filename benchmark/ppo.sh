...
poetry run python -m cleanrl_utils.benchmark \
    ...
    --command "poetry run python cleanrl/ppo_atari_envpool_async_jax_scan_impalanet_machado.py --track --wandb-project-name envpool-atari --save-model --upload-model --hf-entity cleanrl" \
    --num-seeds 1 \
    --workers 1
