...
poetry run python benchmark.py \
    ...
    --command "poetry run python ppo_atari_envpool_async_jax_scan_impalanet_machado.py --track --wandb-project-name envpool-atari --save-model --upload-model --hf-entity cleanrl" \
    --num-seeds 1 \
    --workers 1
