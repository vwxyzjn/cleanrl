...
| | :material-github: [`sac_atari.py`](https://github.com/timoklein/cleanrl/blob/sac-discrete/cleanrl/sac_atari.py), :material-file-document: [docs](https://docs.cleanrl.dev/rl-algorithms/sac/#sac_atarinpy) |
