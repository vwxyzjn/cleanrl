...
| :material-github: [`c51_atari.py`](https://github.com/vwxyzjn/cleanrl/blob/master/cleanrl/c51_atari_jax.py), :material-file-document: [docs](/rl-algorithms/c51/#c51_atari_jaxpy) |  For playing Atari games. It uses convolutional layers and common atari-based pre-processing techniques. |
| :material-github: [`c51.py`](https://github.com/vwxyzjn/cleanrl/blob/master/cleanrl/c51_jax.py), :material-file-document: [docs](/rl-algorithms/c51/#c51_jaxpy) | For classic control tasks like `CartPole-v1`. |
...
Tracked experiments and game play videos:
TODO: update the report link
<iframe src="https://wandb.ai/kinalmehta/cleanrl/reports/Regression-Report-c51_atari_jax--VmlldzozMjM3OTc5" style="width:100%; height:500px" title="CleanRL C51 Tracked Experiments"></iframe>
...
Tracked experiments and game play videos:
TODO: update the report link
<iframe src="https://wandb.ai/kinalmehta/cleanrl/reports/Regression-Report-c51_jax--VmlldzozMjM3OTc0" style="width:100%; height:500px" title="CleanRL C51 Tracked Experiments"></iframe>
