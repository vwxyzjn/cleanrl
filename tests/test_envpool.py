...
def test_ppo_curiosity_critic_envpool():
    subprocess.run(
        "python cleanrl/ppo_curiosity_critic_envpool.py --num-envs 8 --num-steps 32 --num-iterations-obs-norm-init 1 --update-epochs 1 --num-minibatches 1 --total-timesteps 256",
        shell=True,
        check=True,
    )
