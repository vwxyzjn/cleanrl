...
if __name__ == "__main__":
    ...
    parser.add_argument("--n-aux-minibatch", type=int, default=16 * 32, help="the number of mini batch in the auxiliary phase")
...
for phase in range(starting_phase, num_phases):
    for policy_update in range(1, args.n_iteration + 1):
        ...
        if args.anneal_lr:
            frac = 1.0 - (((args.n_iteration) * (phase - 1) + policy_update) - 1.0) / num_updates
            lrnow = lr(frac)
