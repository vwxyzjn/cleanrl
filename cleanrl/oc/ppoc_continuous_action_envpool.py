...
class Agent(nn.Module):
    ...
    def step(self, x: Tensor, option_on_arrival: Tensor) -> StepOutput:
        ...
        return StepOutput(term, option, action, beta, option_logprob, action_logprob, q)
