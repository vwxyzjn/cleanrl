...
class WorldModel(nn.Module):
    def __init__(self, config, num_actions):
        ...
        # Model optimizer
        self.optim_scaler = torch.cuda.amp.GradScaler()
...
class ActorCritic(nn.Module):
    def __init__(self, config, num_actions, wm_fn):
        ...
        # Actor optimizer
        self.actor_optim_scaler = torch.cuda.amp.GradScaler()
        ...
        # Value optimizer
        self.value_optim_scaler = torch.cuda.amp.GradScaler()
    ...
    def _train(self, ac_train_data):
        ...
        with RequiresGrad(actor):
            ...
            self.actor_optim_scaler.update()
        ...
        with RequiresGrad(value):
            ...
            self.value_optim_scaler.update()
