...
class PrioritizedReplayBuffer(ReplayBuffer):
    ...
    def __init__(
        ...
        super(PrioritizedReplayBuffer, self).__init__(buffer_size, observation_space, action_space, device, n_envs=n_envs, optimize_memory_usage=optimize_memory_usage)
    ...
    def sample(self, batch_size: int, beta: float, env: Optional[VecNormalize] = None) -> PrioritizedReplayBufferSamples:
        """
