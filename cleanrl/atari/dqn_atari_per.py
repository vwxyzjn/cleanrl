...
if __name__ == "__main__":
    ...
    rb = PrioritizedReplayBuffer(args.buffer_size, args.pr_alpha, envs.observation_space, envs.action_space, device=device, optimize_memory_usage=True)
    ...
    for global_step in range(args.total_timesteps):
        ...
        if global_step > args.learning_starts and global_step % args.train_frequency == 0:
            ...
            rb.update_weights(data.indeces, new_priorities)
