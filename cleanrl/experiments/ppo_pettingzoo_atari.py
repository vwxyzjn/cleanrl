...
if __name__ == "__main__":
    ...
    parser.add_argument('--gym-id', type=str, default="pettingzoo.atari.tennis_v2",
...
env = importlib.import_module(args.gym_id).parallel_env(obs_type='grayscale_image')
...
envs = ss.concat_vec_envs_v0(env, args.num_envs, num_cpus=args.num_envs, base_class='stable_baselines3')
