...
def select_action(rng_seed, start_e, end_e, duration, t, num_actions, network_def, online_params, obs):
...
if __name__ == "__main__":
    ...
    obs = envs.reset()
    network_def = QNetwork(envs.single_action_space.n)
    ...
    for global_step in range(args.total_timesteps):
        ...
        rng_seed, actions, epsilon = select_action(
            rng_seed,
            args.start_e,
            args.end_e,
