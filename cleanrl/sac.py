...
while global_step < args.total_timesteps:
    ...
    qf1_losses, qf2_losses, policy_losses, alpha_entropy_coefs = np.zeros((4, args.episode_length))
    ...
    for step in range(args.episode_length):
        ...
        if len(rb.buffer) > 2000:
            ...
            if args.autotune:
                alpha_entropy_coefs[step] = log_alpha.exp()
    ...
    writer.add_scalar("losses/alpha_entropy_coef", alpha_entropy_coefs[:step+1].mean(), global_step)
