...
if __name__ == "__main__":
    ...
    obs = make_storage(envs.single_observation_space, (args.num_steps, args.num_envs), device)
    ...
    for update in range(1, num_updates + 1):
        ...
        for step in range(0, args.num_steps):
            ...
            next_obs, next_done = to_tensor(next_obs, device), torch.Tensor(done).to(device)
